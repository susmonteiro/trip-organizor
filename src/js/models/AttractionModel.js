class AttractionModel{
    constructor(attrID = null, attrName = null, attrCoord = [null, null], attrIsFav = false, attrFinished = false,
                attrOnMap = false, attrDate = null, attrNotes = null, attrType = null){
        this.observers = [];        
        this.setID(attrID);
